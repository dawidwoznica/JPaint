 ...
 */
public class CurveDrawCommand implements Command {
    ...
    public CurveDrawCommand(JPaintView view, JPaintViewController controller, int figureIndex, int layerIndex){
