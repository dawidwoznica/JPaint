 ...
 */
public class EllipseDrawCommand implements Command {
    ...
    public EllipseDrawCommand(JPaintView view, JPaintViewController controller, int figureIndex, int layerIndex){
