 ...
 */
public class RectangleDrawCommand implements Command {
    ...
    public RectangleDrawCommand(JPaintView view, JPaintViewController controller, int figureIndex, int layerIndex){
